  ...
  while (true) {
    ...
    if (isInBattle) {
      ...
      if (loopNumber >= 10) {
        ...
        const closeBattleButton = await analyzeImage('close-battle-button.png');
